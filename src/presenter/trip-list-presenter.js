...
export default class TripListPresenter {
  ...
  init() {
    ...
    render(new CreationForm({point: points[1], destinations, offers}), this.#tripListComponent.element);
    //render(new CreationForm({getDefaultPoint(), destinations, offers}), this.tripListComponent.element);
    render(new EditingForm({point: points[0], destinations, offers}), this.#tripListComponent.element);
